...
public interface IClientRepository
{
    ...
    Task<GenericResponse<IEnumerable<Clients>>> GetContactClientsAsync(Guid contactId);
    Task<GenericResponse<IEnumerable<Clients>>> GetUnlinkedClientssAsync(Guid contactId);
