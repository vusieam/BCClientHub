...
public class ClientRepository : IClientRepository
{
    ...
    public async Task<GenericResponse<IEnumerable<Clients>>> GetContactClientsAsync(Guid contactId)
    {
        ...
        try
        {
            using (var db = database.CreateSqlConnection())
            {
                ...
                using (SqlTransaction sqltrans = db.BeginTransaction(IsolationLevel.ReadCommitted))
                {
                    try
                    {
                        string query = "dbo.sp_GetContactClients";
                        var parameters = new
                        {
                            contactId = contactId
                        };
    ...
    public async Task<GenericResponse<IEnumerable<Clients>>> GetUnlinkedClientssAsync(Guid contactId)
    {
        GenericResponse<IEnumerable<Clients>> response = new GenericResponse<IEnumerable<Clients>>();
        try
        {
            using (var db = database.CreateSqlConnection())
            {
                ...
                using (SqlTransaction sqltrans = db.BeginTransaction(IsolationLevel.ReadCommitted))
                {
                    try
                    {
                        string query = "dbo.sp_GetUnlinkedClients";
                        var parameters = new
                        {
                            contactId = contactId
                        };
        ...
        try
        {
            using (var db = database.CreateSqlConnection())
            {
                ...
                using (SqlTransaction sqltrans = db.BeginTransaction(IsolationLevel.ReadCommitted))
                {
                    try
                    {
                        string query = "DELETE T FROM dbo.[Contacts] T WITH(NOLOCK) WHERE T.Id = @Id";
                        var parameters = new
                        {
                            Id = contactId
                        };
